...
<body>
  ...
  <header>
    ...
    <div id="header-right">
      <div id="social">
        <a class="icon-twitter" href="https://twitter.com/#!/<?php isset($options['twitter']) ? $options['twitter'] : 'jungePiraten' ?>" title="Twitter"></a>
        <a class="icon-facebook" href="https://facebook.com/<?php isset($options['facebook']) ? $options['facebook'] : 'jungePiraten' ?>" title="Facebook"></a>
        <a class="icon-flickr" href="http://flickr.com/photos/<?php isset($options['flickr']) ? $options['flickr'] : 'jungePiraten' ?>" title="Flickr"><span>•</span><span>•</span></a>
        <a class="icon-google-plus-sign" href="https://plus.google.com/<?php isset($options['googleplus']) ? $options['googleplus'] : '111687817103191810370' ?>" title="Google Plus"></a>
        <a class="icon-github" href="https://github.com/<?php isset($options['github']) ? $options['github'] : 'jungePiraten' ?>" title="GitHub"></a>
      </div>
