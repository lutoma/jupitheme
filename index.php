...
<?php while (have_posts()) : the_post() ?>
	<article>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<a href="<?php the_permalink(); ?>" class="post_image_link"><span class="copy"><?php $a = get_post_custom_values("Headerbild-Copyright"); echo $a[0]; ?></span><?php the_post_thumbnail(); ?></a>
